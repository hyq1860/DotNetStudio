...
namespace DotNet.CloudFarm.WebSite.WeixinPay
{
    public class JsApiPay
    {
        ...
        public JsApiPay(HttpContextBase httpContextBase)
        {
	    ...
	    */
        public string GetEditAddressParameters()
        {
            ...
            try
            {
                ...
                string queryString = httpContextBase.Request.Url.Query;
        ...
        */
        ...
        {
            if (!string.IsNullOrEmpty(httpContextBase.Request.QueryString["code"]))
            {
                //获取code码，以获取openid和access_token
                string code = httpContextBase.Request.QueryString["code"];
