...
namespace DotNet.Common
{
    ...
    public class RegexLibrary
    {
        ...
        public static Regex RegCellPhone = new Regex(@"^(13[0-9]|15[0|3|6|7|8|9]|18[8|9])\d{8}$");

        public static Regex RegEmail=new Regex(@"^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$");
        #endregion
